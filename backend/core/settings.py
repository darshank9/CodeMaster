...
ALLOWED_HOSTS = ['*']  # For development only, specify exact hosts in production
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'frontend', 'build', 'static'),  # React build directory
]

STATICFILES_DIRS = [
    BASE_DIR / "static",  # Use a valid directory
]
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.TokenAuthentication',  # Keep only TokenAuth
    ],
